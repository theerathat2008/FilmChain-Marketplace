...
class WhatIsFilmchain extends Component {
  renderHeader() {
    return (
      <div>
        <Header as='h2' icon textAlign='center'>
          <Icon name='users' circular />
          <Header.Content>What is FilmChain?</Header.Content>
        </Header>
      </div>
    );
  }
  ...
  renderLinkPosts() {
    return (
      <div>
        <Segment vertical>
          <Link route={`/articles/what-is-filmchain`}>
            What is FilmChain?
          </Link>
...
export default WhatIsFilmchain;
